$(document).ready(function() {
  browserRedirect();
  var imgAnimateList = ['fadeIn', 'flip', "zoomIn", "rollIn", 'fadeIn', 'fadeIn', 'fadeIn']
  var intervalHandle; // 句柄
  $('#fullpage').fullpage({
    sectionsColor: ['#1bbc9b', '#1bbc9b', '#4BBFC3', '#4BBFC3', '#7BAABE', '#7BAABE', '#7BAABE', '#7BAABE', '#7BAABE'],
    anchors: ['firstPage', 'secondPage', 'thirdPage', 'fouthpage', 'fifthPage', 'sixPage', 'sevenPage', 'eightPage', 'ninePage', 'tenPage', 'lastPage'],
    menu: '#menu',
    navigation: true,
