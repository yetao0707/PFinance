                    ...
                    <div id="myCarousel" class="carousel slide">
                        ...
                        <div class="carousel-inner" style="height: 300px">
                            <div class="item active">
                                <img src="<%=basePath%>images/gaosan.jpeg" alt="First slide"
                                     class="img-responsive center-block">
                            </div>
                            <div class="item">
                                <img src="<%=basePath%>images/gaosan.jpeg" alt="Second slide"
                                     class="img-responsive center-block">
                            </div>
                            <div class="item">
                                <img src="<%=basePath%>images/gaosan.jpeg" alt="Third slide"
                                     class="img-responsive center-block">
                            </div>
                        </div>
                        <!-- 轮播（Carousel）导航 -->
