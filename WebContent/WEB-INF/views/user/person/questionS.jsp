...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div id="question6" class="questiondiv  row " value="3+4++">
            ...
            <div id="question7" class="questiondiv  row " value="4+5++">
            ...
            <div id="question9" name="questiondiv  row " value="4+4++">
            ...
            <div id="question13" class="questiondiv  row " value="+3++">
            ...
            <div id="question15" class="questiondiv  row " value="+5++">
            ...
            <div id="question17" class="questiondiv  row " value="+6++">
            ...
            <div id="question19" class="questiondiv  row " value="++4+">
            ...
            <div id="question20" class="questiondiv  row " value="++6+">
            ...
            <div id="question23" class="questiondiv  row " value="++6+">
            ...
            <div id="question24" class="questiondiv  row " value="++6+">
            ...
            <div id="question25" class="questiondiv  row " value="+++2">
            ...
            <div id="question26" name="questiondiv  row " value="+++2">
            ...
            <div id="question27" name="questiondiv  row " value="+++3">
