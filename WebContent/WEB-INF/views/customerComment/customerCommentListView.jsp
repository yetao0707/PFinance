...
%>
<form id="pagerForm" method="post" action="<%=basePath%>customerComment/customerCommentList">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <%--<li><a class="add" href="<%=basePath%>customerComment/update" target="dialog" mask="true"><span>添加</span></a></li>--%>
            <!-- 用于数组传送数据 -->
            <!--
            ...
            <li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" postType="string"
                   href="<%=basePath%>customerComment/delete?ids=${id}" class="delete" target="ajaxTodo" title="确定要删除吗？"
