...
public enum PInvestmentPortfolioEnum {
    ...
    ACCUMULATE_KEEP_REALITY("131",0.45,0.15,0.4,"累积阶段均衡型现实主义"),
    ACCUMULATE_KEEP_IDEA("132",0.5,0.3,0.2,"累积阶段均衡型理想主义"),
    ACCUMULATE_KEEP_ACTION("133",0.6,0.2,0.2,"累积阶段均衡型行动主义"),
    ACCUMULATE_KEEP_PRATICAL("134",0.5,0.2,0.3,"累积阶段均衡型实用主义"),
    ...
    STRENGTHEN_KEEP_REALITY("231",0.3,0.3,0.4,"巩固阶段均衡型现实主义"),
    STRENGTHEN_KEEP_IDEA("232",0.4,0.4,0.2,"巩固阶段均衡型理想主义"),
    STRENGTHEN_KEEP_ACTION("233",0.45,0.35,0.2,"巩固阶段均衡型行动主义"),
    STRENGTHEN_KEEP_PRATICAL("234",0.4,0.3,0.3,"巩固阶段均衡型实用主义"),
    ...
    PAY_KEEP_REALITY("331",0,0.5,0.5,"支出阶段均衡型现实主义"),
    PAY_KEEP_IDEA("332",0.05,0.6,0.35,"支出阶段均衡型理想主义"),
    PAY_KEEP_ACTION("333",0.08,0.65,0.27,"支出阶段均衡型行动主义"),
    PAY_KEEP_PRATICAL("334",0.05,0.5,0.45,"支出阶段均衡型实用主义"),
    ;
